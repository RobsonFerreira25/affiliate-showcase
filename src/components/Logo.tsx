        ...
        <div className={`flex items-center gap-3 ${className}`}>
            <div className="relative h-12 w-12 flex-shrink-0">
                <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-full w-full">
                    {/* Base of the house */}
                    <path d="M20 85H80" stroke="currentColor" strokeWidth="4" strokeLinecap="round" className="text-white/40" />
                    {/* Roof */}
                    <path d="M15 55L50 25L85 55" stroke="currentColor" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" className="text-white/80" />
                    {/* Initials WP */}
            ...
            {showText && (
                <div className="flex flex-col leading-none">
                    <span className="font-display text-2xl font-bold tracking-tight text-white">
                        Wiiki<span className="text-white/60">_</span>Produtos<span className="text-white/60">_</span>
                    </span>
